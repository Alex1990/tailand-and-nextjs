    ...
    <div>
      ...
      <div className="my-4 py-8">
        ...
        <div className="my-8 flex justify-center">
          <button className="mx-4 px-6 py-3 border border-black border-solid rounded">Download</button>
          <button className="mx-4 px-6 py-3 bg-black text-white border border-black border-solid rounded">Buy Now</button>
        </div>
      </div>
      <div className="container mx-auto max-w-screen-xl flex flex-col">
        ...
        <div className="my-10 w-4/5 self-end text-right">
